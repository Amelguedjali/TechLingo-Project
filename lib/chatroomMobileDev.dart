...
class ChatRoomMobileDev extends StatefulWidget {
  const ChatRoomMobileDev({Key? key}) : super(key: key);

  @override
  State<ChatRoomMobileDev> createState() => _ChatRoomMobileDevState();
}

class _ChatRoomMobileDevState extends State<ChatRoomMobileDev> {
  @override
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text("Mobile Dev",style: TextStyle( fontSize: 16 ,fontWeight: FontWeight.w600, fontFamily: 'Poppins'),),
                        SizedBox(height: 0),
