...
class ChatRoomDesign extends StatefulWidget {
  const ChatRoomDesign({Key? key}) : super(key: key);

  @override
  State<ChatRoomDesign> createState() => _ChatRoomDesignState();
}
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text("Design",style: TextStyle( fontSize: 16 ,fontWeight: FontWeight.w600, fontFamily: 'Poppins'),),
                        SizedBox(height: 0),
