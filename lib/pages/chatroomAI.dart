...
class ChatRoomAI extends StatefulWidget {
  const ChatRoomAI({Key? key}) : super(key: key);
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text("AI",style: TextStyle( fontSize: 16 ,fontWeight: FontWeight.w600, fontFamily: 'Poppins'),),
                        SizedBox(height: 0),
            ...
            Container(
              ...
              child: ListView(
                ...
                children:[
                  ...
                  buildOwnMessage(context ,'Azerty',  'a', '23:10'),
