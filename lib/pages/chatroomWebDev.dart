...
class ChatRoomWebDev extends StatefulWidget {
  const ChatRoomWebDev({Key? key}) : super(key: key);

  @override
  State<ChatRoomWebDev> createState() => _ChatRoomWebDevState();
}

class _ChatRoomWebDevState extends State<ChatRoomWebDev> {
  @override
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text("Web Dev",style: TextStyle( fontSize: 16 ,fontWeight: FontWeight.w600, fontFamily: 'Poppins'),),
                        SizedBox(height: 0),
