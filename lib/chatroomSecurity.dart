...
class ChatRoomSecurity extends StatefulWidget {
  const ChatRoomSecurity({Key? key}) : super(key: key);

  @override
  State<ChatRoomSecurity> createState() => _ChatRoomSecurityState();
}

class _ChatRoomSecurityState extends State<ChatRoomSecurity> {
  @override
            ...
            child: Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  SizedBox(width: 2,),
                  CircleAvatar(
                    backgroundImage: AssetImage("assets/Security.png"),
                    maxRadius: 20,
                  ),
                  SizedBox(width: 12,),
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text("Cyber Security",style: TextStyle( fontSize: 16 ,fontWeight: FontWeight.w600, fontFamily: 'Poppins'),),
                        SizedBox(height: 0),
